...
@section('content')
    ...
    <div class="container-fluid py-4">
        <form method="POST" action="{{ route('admin.admin-dashboard.branch.edit',['slug'=>$branch->slug]) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-9">
                    <div class="card">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Branch Phone
                                            Number</label>
                                        <input class="form-control" type="number"  name="phone" value="{{$branch->phone}}">
                                    </div>
                ...
                <div class="col-md-3">
                    <div class="card ">
                        <div class="card-body">
                            <input type="file" name="image" id="image" class="photo" data-default-file={{asset($branch->image)}}>
                        </div>
                    </div>
                </div>
            </div>
