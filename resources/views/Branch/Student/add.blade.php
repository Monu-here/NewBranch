...
@section('content')
            ...
            <div class="row gx-4">
                <div class="  my-auto ">
                    <div class="h-100  " style="display: flex; justify-content: space-between">
                        ...
                        <span>
                            <a href="{{ route('admin.branch-dashboard.index') }}">
                                <span class="mb-1 " style="text-transform: capitalize">
                                    Dashboard |
                                </span>
                            </a>
                            <a href="{{ route('admin.branch-dashboard.student.index') }}">
                                <span class="mb-1 " style="text-transform: capitalize">
                                    Student Info |
                                </span>
                            </a>
    ...
    <div class="container-fluid py-4">
        <form method="POST" action="{{ route('admin.branch-dashboard.student.add') }}" enctype="multipart/form-data">
            @csrf
