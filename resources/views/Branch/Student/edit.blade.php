...
@section('content')
    ...
    <div class="container-fluid py-4">
        <form method="POST" action="{{ route('admin.admin-dashboard.student.edit', ['slug' => $student->slug]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nepali-datepicker" class="form-control"
                                            name="admission_date" placeholder=" " value="{{ $student->admission_date }}" />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="nepali-datepickers" name="dob"
                                            value="{{ $student->dob }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" value="{{ $student->phone }}"
                                            name="phone">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ $student->address }}"
                                            name="address">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ $student->father_name }}"
                                            name="father_name">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Father Phone
                                            Number</label>
                                        <input class="form-control" type="number" value="{{ $student->father_phone }}"
                                            name="father_phone">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ $student->course }}"
                                            name="course">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"
                                            value="{{ $student->doument_text_1 }}" name="doument_text_1">
                                        <br>
                                        <input class="form-control" type="file" placeholder="01"
                                            name="doument_image_1" value="{{ $student->doument_image_1 }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Document 02
                                            Name</label>
                                        <input class="form-control" type="text"
                                            value="{{ $student->doument_text_2 }}" name="doument_text_2">
                                        <br>
                                        {{-- <label for="example-text-input" class="form-control-label">Document 01
                                            Name</label> --}}
                                        <input class="form-control" type="file" value="02" name="doument_image_2"
                                            value="{{ $student->doument_image_2 }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Document 03
                                            Name</label>
                                        <input class="form-control" type="text"
                                            value="{{ $student->doument_text_3 }}" name="doument_text_3">
                                        <br>
                                        {{-- <label for="example-text-input" class="form-control-label">Document 01
                                            Name</label> --}}
                                        <input class="form-control" type="file" value="03" name="doument_image_3"
                                            value="{{ $student->doument_image_3 }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Document 04
                                            Name</label>
                                        <input class="form-control" type="text"
                                            value="{{ $student->doument_text_4 }}" name="doument_text_4">
                                        <br>
                                        {{-- <label for="example-text-input" class="form-control-label">Document 01
                                            Name</label> --}}
                                        <input class="form-control" type="file" value="04" name="doument_image_4"
                                            value="{{ $student->doument_image_4 }}">
                                    </div>
                                </div>
